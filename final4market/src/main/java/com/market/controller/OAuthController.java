...
public class OAuthController {
    ...
    public String naverCallback(String access_token) {
        return "redirect:http://localhost:3000/naverAuthCallback?access_token=" + access_token;
    }
    ...
    public String kakaoCallback(@RequestParam String code) {
        ...
        // 코튼 정보 프론트로 전달
        return "redirect:http://localhost:3000/kakaoAuthCallback?access_token=" + accessToken;
    }
